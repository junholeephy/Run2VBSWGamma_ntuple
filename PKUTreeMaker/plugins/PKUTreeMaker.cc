...
// Filter
  ...
  double Mla, Mva;
  double Mla_f, Mva_f;
  double ptlep1, etalep1, philep1, muisolation, d0vtx, dzvtx;
...
//jets
  ...
  outTree_->Branch("d0vtx"               ,&d0vtx              ,"d0vtx/D"  );
  outTree_->Branch("dzvtx"               ,&dzvtx              ,"dzvtx/D"  );
...
//------------------------------------
	...
	double muchaiso, muneuiso, muphoiso, muPU;
	muchaiso = -100;
	muneuiso = -100;
	muphoiso = -100;
	muPU = -100;
	...
	if( leptonicV.daughter(0)->isMuon()||leptonicV.daughter(1)->isMuon()){
		if(abs(leptonicV.daughter(0)->pdgId())==13 )	{
			const pat::Muon *mu1 = (pat::Muon*)leptonicV.daughter(0);
...
//			muisolation = (mu1.pfIsolationR04().sumChargedHadronPt+ std::max(0.0,mu1.pfIsolationR04().sumNeutralHadronEt+mu1.pfIsolationR04().sumPhotonEt-0.5*mu1.pfIsolationR04().sumPUPt))/mu1.pt();
		...
		const pat::Muon *mu1 = (pat::Muon*)leptonicV.daughter(1);
//		trackIso = mu1->trackIso();
                muchaiso=mu1->pfIsolationR04().sumChargedHadronPt;
              muneuiso=mu1->pfIsolationR04().sumNeutralHadronEt;
                muphoiso=mu1->pfIsolationR04().sumPhotonEt;
...
//Inverting loose ID
            if(passEleVetonew && (*photons)[ip].isEB() && /*(*photons)[ip].hadTowOverEm()>0 &&*/ (*photons)[ip].hadTowOverEm()<0.0597 && chiso<15 && nhiso<std::min(0.2*(*photons)[ip].pt(), 5.*(10.910 + (0.0148*(*photons)[ip].pt()+0.000017*(*photons)[ip].pt()*(*photons)[ip].pt())))  && phoiso<std::min(0.2*(*photons)[ip].pt(), 5.*(3.630+0.0047*(*photons)[ip].pt())) && !(photon_sieie[ip]<0.01031 && chiso<3) /*&& nhiso>0 && phoiso>0*/) {ismedium_photon_f=1;}  // && nhiso<(10.910 + (0.0148*(*photons)[ip].pt()+0.000017*(*photons)[ip].pt()*(*photons)[ip].pt())) && phoiso<(3.630+0.0047*(*photons)[ip].pt())
            if(passEleVetonew && (*photons)[ip].isEE() && /*(*photons)[ip].hadTowOverEm()>0 &&*/ (*photons)[ip].hadTowOverEm()<0.0481 && chiso<15 && nhiso<std::min(0.2*(*photons)[ip].pt(), 5.*(5.931 + (0.0163*(*photons)[ip].pt()+0.000014*(*photons)[ip].pt()*(*photons)[ip].pt())))  && phoiso<std::min(0.2*(*photons)[ip].pt(), 5.*(6.641+0.0034*(*photons)[ip].pt())) && !(photon_sieie[ip]<0.03013 && chiso<3) /*&& nhiso>0 && phoiso>0*/) {ismedium_photon_f=1;}  // && nhiso<(5.931 + (0.0163*(*photons)[ip].pt()+0.000014*(*photons)[ip].pt()*(*photons)[ip].pt())) && phoiso<(6.641+0.0034*(*photons)[ip].pt())
