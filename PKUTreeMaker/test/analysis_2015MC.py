...
if runOnMC:
   process.GlobalTag.globaltag = '80X_mcRun2_asymptotic_2016_miniAODv2'  #'76X_mcRun2_asymptotic_v12' # '74X_mcRun2_asymptotic_v2'#'for version2 miniaod 
elif not(runOnMC):
   process.GlobalTag.globaltag = '80X_dataRun2_Prompt_v8' #'76X_dataRun2_v15' #'74X_dataRun2_reMiniAOD_v0' #'74X_dataRun2_Prompt_v4' # for 2015D prompt v4
...
if runOnMC:
   jecLevelsAK4chs = [
                               'Spring16_25nsV1_MC_L1FastJet_AK4PFchs.txt',   # 'Fall15_25nsV2_MC_L1FastJet_AK4PFchs.txt',
                               'Spring16_25nsV1_MC_L2Relative_AK4PFchs.txt',   # 'Fall15_25nsV2_MC_L2Relative_AK4PFchs.txt',
                               'Spring16_25nsV1_MC_L3Absolute_AK4PFchs.txt'   # 'Fall15_25nsV2_MC_L3Absolute_AK4PFchs.txt'
     ]
else:
   jecLevelsAK4chs = [
                                'Spring16_25nsV3_DATA_L1FastJet_AK4PFchs.txt',   #'Fall15_25nsV2_DATA_L1FastJet_AK4PFchs.txt',
                                'Spring16_25nsV3_DATA_L2Relative_AK4PFchs.txt',   #'Fall15_25nsV2_DATA_L2Relative_AK4PFchs.txt',
                                'Spring16_25nsV3_DATA_L3Absolute_AK4PFchs.txt',   #'Fall15_25nsV2_DATA_L3Absolute_AK4PFchs.txt',
                                'Spring16_25nsV3_DATA_L2L3Residual_AK4PFchs.txt'   #'Fall15_25nsV2_DATA_L2L3Residual_AK4PFchs.txt'
     ] 
#end------------JEC on the fly--------
