...
if runOnMC:
   ...
   process.GlobalTag.globaltag = '80X_dataRun2_2016SeptRepro_v7'  #80X_dataRun2_2016SeptRepro_v4'
...
#                                    muPaths3     = cms.vstring("HLT_IsoMu24_v*","HLT_IsoTkMu24_v*"),#"HLT_IsoMu27_v*"), #B2G-15-005
